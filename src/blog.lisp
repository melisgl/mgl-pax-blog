...
(defpost @untangling-literate-programming
  ...
  generated by a process called _tangling_, and documentation by
  _weaving_. The specifics of tangling vary, but the important point
  ...
  introducing an additional step into the write-compile-run cycle.
  ...
  untangled LP suffers from the following potential problems.

  1. _Order mismatches_: Things like inline functions and global
